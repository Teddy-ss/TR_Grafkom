...
void tampil(void)
{
    ...
    // JENDELA LANTAI 1 BAGIAN BELAKANG DARI TENGAH DEPAN KANAN (3)
    glBegin(GL_QUADS);
    glColor3f(0.8, 0.8, 0.8);   // WARNA jendela
    glVertex3f(58.0, -10.0, 20.5); // Z aku buat 50 buat tengah depan 
    glVertex3f(58.0, 10.0, 20.5);
    ...
    // GARIS JENDELA LANTAI 1 BAGIAN BELAKANG DARI TENGAH DEPAN KANAN (3)
    glBegin(GL_LINE_LOOP);
    glColor3f(0.5, 0.5, 0.6);    // WARNA jendela
    glVertex3f(58.0, -10.0, 20.5); // Z aku buat 50 buat tengah depan 
    glVertex3f(58.0, 10.0, 20.5);
    ...
    // GARIS JENDELA LANTAI 1 BAGIAN BELAKANG DARI TENGAH DEPAN KANAN (TENGAH VERTIKAL) (3)
    glBegin(GL_LINES);
    glColor3f(0.5, 0.5, 0.6);    // WARNA jendela
    glVertex3f(55.0, -10.0, 20.6); // Z aku buat 50 buat tengah depan 
    glVertex3f(55.0, 10.0, 20.6);
    ...
    // GARIS JENDELA LANTAI 1 BAGIAN BELAKANG DARI TENGAH DEPAN KANAN (TENGAH HORIZONTAL) (3)
    glBegin(GL_LINES);
    glColor3f(0.5, 0.5, 0.6);    // WARNA jendela
    glVertex3f(58.0, -0.0, 20.6); // Z aku buat 50 buat tengah depan 
    glVertex3f(52.0, 0.0, 20.6);
